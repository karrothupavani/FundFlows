...
const MyTable = () => {
  ...
  const getData = ()=>{
    try {
      axios
        .get('https://api.p360.build:6060/v1/fundflow/r2cSurplusFundsTransfer/fetchAll', {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
    ...
    <div style={{ display: 'flex' }}>
      <div style={{ padding: '25px', width: '100%' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <Typography variant="h4">R2C Surplus Funds Transfer</Typography>
         <div>
          <Button
        type="primary"
