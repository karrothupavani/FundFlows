...
useEffect(() => {
 getData();
  ...
  const columns = [
    ...
    {
      title: 'Loan Issued Project',
      dataIndex: 'loanIssuedProject',
      width: '10%',
      key: 'loanIssuedProject',
      render: (text, record) => renderCell(record, 'loanIssuedProject', text),
    },
    {
      title: 'Loan Received Project',
      dataIndex: 'loanReceivedProject',
      width: '10%',
      key: 'loanReceivedProject',
      render: (text, record) => renderCell(record, 'loanReceivedProject', text),
    },
  ...
  const getData = ()=>{
    try {
      axios
        .get('https://api.p360.build:6060/v1/fundflow/ro2roloans/fetchAll', {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
    ...
    <div style={{ display: 'flex' }}>
      ...
      <div style={{ padding: '25px', width: '100%' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <Typography variant="h4">RO To RO Loans</Typography>
         <div>
          <Button
        type="primary"
